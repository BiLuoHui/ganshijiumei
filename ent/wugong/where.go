...
func ID(id int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
...
func Damage(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldDamage), v))
	})
}
...
func DamageNEQ(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.NEQ(s.C(FieldDamage), v))
	})
}
...
func DamageIn(vs ...int) predicate.WuGong {
	...
	return predicate.WuGong(func(s *sql.Selector) {
		...
		s.Where(sql.In(s.C(FieldDamage), v...))
	})
}
...
func DamageNotIn(vs ...int) predicate.WuGong {
	...
	return predicate.WuGong(func(s *sql.Selector) {
		...
		s.Where(sql.NotIn(s.C(FieldDamage), v...))
	})
}
...
func DamageGT(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.GT(s.C(FieldDamage), v))
	})
}
...
func DamageGTE(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.GTE(s.C(FieldDamage), v))
	})
}
...
func DamageLT(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.LT(s.C(FieldDamage), v))
	})
}
...
func DamageLTE(v int) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		s.Where(sql.LTE(s.C(FieldDamage), v))
	})
}
...
func Not(p predicate.WuGong) predicate.WuGong {
	return predicate.WuGong(func(s *sql.Selector) {
		p(s.Not())
	})
}
